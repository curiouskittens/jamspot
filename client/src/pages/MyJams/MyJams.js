...
class MyJams extends Component {
  ...
  sortJams = jams => {
    ...
    const pastJams = sortedJams
      .filter(jam => moment(jam.date) - moment() < 0)
      .reverse();
        ...
        <div className="find-jam-page-bg">
          <div className="find-jam-page-content container-fluid">
            ...
            <div className="row d-md-flex">
              {this.state.upcomingJams.length ? (
                this.state.upcomingJams.map((jam, idx) => {
            ...
            <hr />
            <div className="row d-md-flex">
              {this.state.pastJams.length ? (
                this.state.pastJams.map((jam, idx) => {
                  if (jam.admin._id === sessionStorage.getItem("userId")) {
                    return (
                      <JamCard
                        classes={"col-12 col-md-6 col-xl-4 jam-card-wrapper"}
