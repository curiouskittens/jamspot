...
class Footer extends Component {
  state = {
    footer: "footer",
    footerTriggerStyles:
      "footer-trigger-text-style text-center " + this.props.animate,
    footerShown: false
  };
  ...
  renderFooter = () => {
    if (this.state.footerShown === false) {
      return (
        <div
          className={this.state.footerTriggerStyles}
          onClick={this.toggleFooter}
        >
          Made by curiouskittens <i className="fas fa-paw" />
        </div>
      );
    } else {
      return (
        ...
        >
          Made by
          <a
            href="https://github.com/orgs/curiouskittens"
            target="react/jsx-no-target-blank"
          >
            {" "}
            curiouskittens <i className="fas fa-paw" />
          </a>
        </div>
      );
    }
      ...
      <footer className={this.state.footer}>
        ...
        <div className="footer-wrapper">
          <div className="container text-center">
            ...
            <div>
              <a
                href="https://github.com/carladdg"
                className="footer-link-text-style"
                target="react/jsx-no-target-blank"
              >
                Carla Garcia
              </a>
              <br />
              <a
                href="https://github.com/davidbinstock"
                className="footer-link-text-style"
                target="react/jsx-no-target-blank"
              >
                David Binstock
